...
const policyLinks = [
  ...
  { label: 'Privacy Policy', href: getPolicyUrl('privacy-policy') },
  { label: 'Refund Policy', href: getPolicyUrl('refund-policy') },
  { label: 'Shipping Policy', href: getPolicyUrl('shipping-policy') },
];
