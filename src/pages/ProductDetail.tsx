...
const ProductDetail = () => {
  ...
  const hasDiscount = compareAtPrice && parseFloat(compareAtPrice.amount) > parseFloat(selectedVariant?.price.amount || '0');
  const discountPercent = hasDiscount && compareAtPrice
    ? Math.round(((parseFloat(compareAtPrice.amount) - parseFloat(selectedVariant?.price.amount || '0')) / parseFloat(compareAtPrice.amount)) * 100)
    : 0;
          ...
          <div>
            ...
            <div className="mb-6">
              <div className="flex items-center gap-3 mb-2">
                ...
                {hasDiscount && (
                  <span className="text-sm font-semibold text-destructive bg-destructive/10 px-3 py-1 rounded">
                    -{discountPercent}% OFF
                  </span>
                )}
              </div>
